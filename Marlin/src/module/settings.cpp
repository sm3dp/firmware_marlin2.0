...
#if ENABLED(LOTMAXX_MULTI_LANGUAGE)
  #include "../lcd/extui/dgus/DGUSScreenHandler.h"
#endif
...
#include "../core/debug_out.h"
  ...
  bool MarlinSettings::save() {
    ...
    //
    #if ENABLED(LOTMAXX_MULTI_LANGUAGE)
      EEPROM_WRITE(ScreenHandler.get_language_choice());
    #endif

    // laser focus location 
    #if ENABLED(LOTMAXX_LASER_PRINTMODE)
      EEPROM_WRITE(focusLocation);
    #endif
  ...
  bool MarlinSettings::_load() {
    ...
    if (strncmp(version, stored_ver, 3) != 0) {
      ...
      //
      #if ENABLED(LOTMAXX_MULTI_LANGUAGE)
        EEPROM_READ(*(ScreenHandler.get_language_choice_p()));
      #endif

       // laser focus location 
      #if ENABLED(LOTMAXX_LASER_PRINTMODE)
        EEPROM_READ(focusLocation);
      #endif
